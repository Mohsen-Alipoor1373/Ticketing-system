    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group mb-3">
                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="ReturnPassword" required autocomplete="new-password">
                    <div class="input-group-append">
                        <span class="fa fa-lock input-group-text"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-8">
                        <div class="checkbox icheck">
                            <label>
                                <a href="{{url('login')}}" class="btn btn-danger btn-block btn-flat">من قبلا ثبت نام کرده ام</a>
                            </label>
                        </div>
                    </div>
                    <!-- /.col -->
